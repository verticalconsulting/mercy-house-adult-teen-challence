      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-10 text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <section>
            ...
            <h3 className="text-xl font-bold text-navy dark:text-gold mt-6 mb-2">SMS Privacy Policy</h3>
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li>
                <strong>Mobile Number Privacy:</strong> We do <strong>not</strong> sell, rent, share, or disclose
                your mobile phone number to any third party for marketing purposes. Your mobile number is used solely
                by Mercy House and our SMS service provider (Twilio) to deliver the messages you have opted in to
                receive. Twilio processes messages on our behalf under a service agreement and is bound by its own
                privacy and data protection obligations.
              </li>
              <li>
                <strong>Information Stored:</strong> When you opt in, we record your mobile number, the date and time
                of consent, and the messages sent to you for record-keeping and compliance purposes.
              </li>
              <li>
                <strong>Message Frequency:</strong> Message frequency varies based on your scheduled volunteer shifts
                and program activity, typically <strong>1–4 messages per month</strong>. You will not receive
                automated promotional messages unrelated to your volunteer service unless you separately request them.
              </li>
              <li>
                <strong>Message &amp; Data Rates:</strong> <strong>Standard message and data rates may apply</strong>
                according to your mobile carrier plan. Mercy House is not responsible for any charges your carrier may
                apply for receiving text messages.
              </li>
              <li>
                <strong>Opt-Out &amp; Help:</strong> You may cancel your SMS subscription at any time by replying
                <strong> STOP</strong> to any message. To request assistance, reply <strong>HELP</strong>. You may
                also opt out by emailing <a href="mailto:info@mercyhouseatc.com" className="text-navy dark:text-gold hover:underline">info@mercyhouseatc.com</a>{' '}
                or calling 855-893-7333.
              </li>
            </ul>

            <h3 className="text-xl font-bold text-navy dark:text-gold mt-6 mb-2">SMS Terms of Service</h3>
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li>
                <strong>Opt-In Consent:</strong> By checking the SMS opt-in box on our volunteer application form and
                providing your mobile number, you affirmatively consent to receive text messages from Mercy House
                Adult &amp; Teen Challenge. Consent is not a condition of volunteering.
              </li>
              <li>
                <strong>Eligibility:</strong> You must be at least 18 years of age and the owner of the mobile number
                provided, or have authorization from the account holder to consent on their behalf.
              </li>
              <li>
                <strong>Automated System:</strong> Messages are sent using an automatic telephone dialing system or
                similar technology.
              </li>
              <li>
                <strong>Carrier Responsibility:</strong> Message delivery is subject to your mobile carrier's network
                availability and policies. Mercy House is not liable for delayed or undelivered messages.
              </li>
              <li>
                <strong>Program Changes:</strong> We reserve the right to modify or discontinue the SMS program at any
                time. We will update these terms on this page if material changes occur.
              </li>
              <li>
                <strong>Liability:</strong> Mercy House is not liable for any damages arising from the use of or
                inability to use the SMS program to the maximum extent permitted by law.
              </li>
            </ul>
