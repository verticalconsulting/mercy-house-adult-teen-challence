                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-6 rounded-xl space-y-4">
                  ...
                  <div className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed space-y-2 pl-0">
                    ...
                    <p>
                      ...
                      <a href="/privacy-policy" className="text-navy dark:text-gold underline hover:opacity-80">Privacy Policy</a>{' '}and{' '}
                      <a href="/terms-conditions" className="text-navy dark:text-gold underline hover:opacity-80">Terms of Service</a>.
                    </p>
                  </div>
                </div>
